...
{
    public partial class frmScrnSaver : Form
    {
        ...
        private void frmScrnSaver_KeyDown(object sender, KeyEventArgs e)
        {
            Close();
        }

        private void frmScrnSaver_Load(object sender, EventArgs e)
        {
        ...
        private void frmScrnSaver_Paint(object sender, PaintEventArgs e)
        {
